...
public class NiceTheoryAttribute : Xunit.TheoryAttribute
{
    /// <summary>
    ///     <para>
    ///         Marks a test method as being a data theory. Data theories are tests which
    ...
    /// </param>
    public NiceTheoryAttribute(string charsToReplace = "_", string replacementChars = " ", [CallerMemberName] string testMethodName = "")
    {
